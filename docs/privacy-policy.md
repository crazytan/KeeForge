...
**We collect nothing.** No analytics, no tracking, no telemetry, no crash reports, no personal data. Zero.
...
The AutoFill extension operates locally on your device. Credential suggestions are generated from your local database and are never sent anywhere.
